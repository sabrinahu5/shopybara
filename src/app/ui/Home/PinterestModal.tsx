...
export default function PinterestModal({
  isOpen,
  onClose,
}: PinterestModalProps) {
        ...
        {isLoading ? (
          ...
          <>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              To personalize your experience, please add a link to your
              Pinterest board that represents your room style inspiration.
            </p>
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center gap-6">
                <a
                  href="/home"
                  className="px-8 py-0.5 border-2 border-black dark:border-white uppercase bg-[#FF0000] text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]"
                >
                  Cancel
                </a>
